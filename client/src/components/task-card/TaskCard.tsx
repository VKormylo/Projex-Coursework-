...
type Props = {
  ...
  /** Tooltip shown on the chevron button */
  actionTitle?: string
}
    ...
    >
      ...
      <ChevronRightIcon
        className={`ml-3 shrink-0 transition ${
          interactive
            ? 'text-[#93c5fd] group-hover:text-[#1447e6]'
            : 'text-[#a0aec0]'
        }`}
      />
    </div>
