...
import { clearSession, getStoredToken, saveSession } from "~/utils/auth-storage";
...
function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signIn = useCallback((token: string, userId: string, persistent: boolean) => {
  ...
  return (
    <AuthContext.Provider value={{ accessToken, user, isAuthenticated, signIn, signOut, refreshUser }}>
      {children}
